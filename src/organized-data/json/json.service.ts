...
import { jsonZeroShotSchemaExtraction, jsonZeroShotSchemaExtractionRefine } from './prompts';
...
export class JsonService {
    ...
    async extrctWithSchemaAndRefine(text: string, model: string ,  schema: string) {
